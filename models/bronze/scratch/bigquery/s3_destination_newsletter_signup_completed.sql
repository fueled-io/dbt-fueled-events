...
SELECT
  ...
  CAST(NULL AS STRING) AS address_country_code,
  ...
  CAST(NULL AS STRING) AS visitor_type,
  ...
  CAST(NULL AS STRING) AS address_state_code,
  ...
  CAST(NULL AS STRING) AS address_country,
  ...
  CAST(NULL AS STRING) AS order_count,
  ...
  CAST(NULL AS STRING) AS external_customer_id,
  ...
  CAST(NULL AS STRING) AS address_street,
  ...
  CAST(NULL AS STRING) AS lifetime_value,
  ...
  CAST(JSON_VALUE(context, '$.campaign.agid') AS BOOL) AS context_campaign_agid,
...
SELECT
  ...
  CAST(NULL AS FLOAT64) AS lifetime_value,
  ...
  CAST(NULL AS BOOL) AS context_campaign_agid,
