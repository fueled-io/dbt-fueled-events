...
SELECT 
  ...
  SAFE_CAST(JSON_VALUE(context, '$.campaign.content') AS BOOL) AS context_campaign_content,
...
SELECT
  ...
  SAFE_CAST(NULL AS STRING) AS context_initialized,
  ...
  SAFE_CAST(NULL AS STRING) AS context_offline,
  ...
  SAFE_CAST(NULL AS BOOL) AS context_campaign_content,
